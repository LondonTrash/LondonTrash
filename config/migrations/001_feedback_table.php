 ...
 */
	public $migration = array(
		'up' => array(
			'create_table' => array(
				...
				'notifications' => array(
					...
					'last_sent' => array('type' => 'integer', 'null' => true, 'default' => NULL),
					'collection_type' => array('type' => 'string', 'null' => true, 'default' => NULL, 'collate' => 'latin1_swedish_ci', 'charset' => 'latin1'),
					'indexes' => array(
						'PRIMARY' => array('column' => 'id', 'unique' => 1),
					),
					'tableParameters' => array('charset' => 'latin1', 'collate' => 'latin1_swedish_ci', 'engine' => 'MyISAM'),
		...
		'down' => array(
			'drop_table' => array(
				'address_caches', 'admins', 'contents', 'feedbacks', 'notifications', 'protocols', 'providers', 'subscribers', 'update_signups', 'zones'
			),
		),
	);
